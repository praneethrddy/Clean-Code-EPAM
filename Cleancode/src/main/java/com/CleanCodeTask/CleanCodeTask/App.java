...
public class App
{
    ...
    public static void main( String[] args )
    {
    	...
    	do {
    		...
    		case '1':  getInterestDetails();
    		      SimpleInterest simpleinterest = new SimpleInterest(pamount,roInterest,tperiod);
    		      output.print("Simple Interest is "+ simpleinterest.getSimpleInterest()+"\n");
    		      break;
    		case '2': getInterestDetails();
    		      CompoundInterest compoundinterest = new CompoundInterest(pamount,roInterest,tperiod);
    ...
    public static void getInterestDetails() {
    	...
    	roInterest = scanner.nextDouble();
    	tperiod = scanner.nextDouble();
    }
